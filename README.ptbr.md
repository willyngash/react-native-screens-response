# Conteúdo
* [Sobre](#react-native-screens-response)
...
# react-native-screens-response


<i>react-native-screens-response</i> é uma pequena biblioteca que provê 2 métodos simples para que desenvolvedores React Native possam criar componentes completamente responsivos. Nenhuma media query é necessária.
...
`npm install react-native-screens-response --save`

or

`yarn add react-native-screens-response`
...
```javascript
import {widthPercentageToDP as wp, heightPercentageToDP as hp} from 'react-native-screens-response';
