...
# Contents
* [The package](#react-native-screens-response)
...
<i>react-native-screens-response</i> is a small library that provides 2 simple methods so that React Native developers can code their UI elements fully responsive. No media queries needed.
